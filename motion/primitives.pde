...
//void capletSection(pt A, float r2, pt B, float r1) { // cone section surface that is tangent to Sphere(A,a) and to Sphere(B,b)
//  float d = d(A, B);
//  float r2Mr1 = r2-r1;
//  vec ABVec = V(A, B);
//  float Ad = r2Mr1/d*r2, Bd = r2Mr1/d*r1, reald = d-Ad+Bd;
//  vec V2 = V(A, B).normalize().mul(-reald);
//  vec I2 = U(Normal(V2));
//  vec J2 = U(N(I2, V2));
//  float r11 = sqrt(r1*r1-Bd*Bd), r22=sqrt(r2*r2-Ad*Ad);
//  vec tmp = ABVec.normalize().mul(Bd);
//  pt BB = P(B, tmp);
//  collar(BB, V2, I2, J2, r11, r22);
//} 
